...
@Component @Order(100)
public class KafkaMetricCollector extends TechnologyBuiltInMetricCollector {
    public KafkaMetricCollector(InfrastructureMapper i, InfrastructureResourceMapper r, TopologyNodeMapper n,
                                TopologyEdgeMapper e, MetricSampleMapper s, JsonMetricValueReader v) {
        super("KAFKA_", i, r, n, e, s, v);
    }
}
