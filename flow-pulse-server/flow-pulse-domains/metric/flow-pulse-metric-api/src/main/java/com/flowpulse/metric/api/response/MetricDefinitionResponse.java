...
public class MetricDefinitionResponse {
    ...
    private List<MetricApplicabilityResponse> applicabilityRules;
    ...
    public List<MetricApplicabilityResponse> getApplicabilityRules() { return applicabilityRules; }
    public void setApplicabilityRules(List<MetricApplicabilityResponse> applicabilityRules) { this.applicabilityRules = applicabilityRules; }
}
