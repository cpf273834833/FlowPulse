...
public class TopologyEdgeSaveRequest {
    private String id;
    @NotBlank(message = "{topology.edge.key.required}")
    private String edgeKey;
    private String edgeName;
    private String edgeType;
    @NotBlank(message = "{topology.edge.source.required}")
    private String sourceNodeId;
    @NotBlank(message = "{topology.edge.target.required}")
